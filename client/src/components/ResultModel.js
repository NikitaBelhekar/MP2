        ...
        <>
          {loading ? (
            <>
              ...
              >
                {" "}
                <Loading label={"making a delete request.."} />
              </Box>{" "}
            </>
          ) : (
            <>
        ...
        <Box>
          ...
          >
            ...
            >
              ...
              <Typography>
                {" "}
                Ayurvedic Names: {finalData?.ayurvedic_names?.join(", ")}
              </Typography>
            </Box>
          </DialogTitle>
          <IconButton
          ...
          <DialogContent dividers sx={{ backgroundColor: "#F5F5DC" }}>
            <Box sx={{ padding: "1rem" }}>
              ...
              <Stack>
                ...
                <Typography
                  sx={{ borderColor: "ActiveBorder", padding: "10px" }}
                >
                  <strong>Primary:</strong>{" "}
                  {finalData?.doshic_imbalance?.primary}
                </Typography>
                <Typography
                  sx={{
                    borderBottom: 1,
                ...
                >
                  ...
                  {finalData?.doshic_imbalance?.secondary.join(",")}
                </Typography>
